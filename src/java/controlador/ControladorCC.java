...
@WebServlet(name = "ControladorCC", urlPatterns = {"/ControladorCC"})
public class ControladorCC extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (action) {
            case "Agregar":
                ...
                request.getRequestDispatcher("ControladorCC?action=inicio").forward(request, response);
                break;
            ...
            case "Comprar":
                ...
                request.setAttribute("contador", listacarrito.size());
                request.getRequestDispatcher("indexCarrito.jsp").forward(request, response);
                break;
