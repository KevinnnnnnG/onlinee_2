                ...
                <c:forEach var="p" items="${productos}">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            ...
                            <a href="ControladorCU?action=Agregar&id=${p.getId()}" class="btn btn-primary btn-block">Agregar a carrito</a>
                            <a href="ControladorCU?action=Comprar&id=${p.getId()}" class="btn btn-warning btn-block">Comprar</a>
                        </div>
                    </div>                    
                </c:forEach> 
            </div>                    
